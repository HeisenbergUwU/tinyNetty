...
public final class StringUtil {
    ...
    private static final String[] BYTE2HEX_PAD = new String[256]; // 0a -- 有导0
    private static final String[] BYTE2HEX_NOPAD = new String[256]; // a
    ...
    public static String byteToHexStringPadded(int value) {
        return BYTE2HEX_PAD[value & 0xff]; // 防止数组越界
    }
