...
import io.donkey.concurrent.ThreadProperties;
...
// SingleThreadEventExecutor 是 Netty 线程模型的核心基类，它在 AbstractScheduledEventExecutor 基础上实现了 单线程串行化执行模型，是 Netty 高性能、无锁化设计的基石
@Slf4j
